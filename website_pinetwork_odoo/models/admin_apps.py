...
class admin_apps(models.Model):
    ...
    pi_users_winners_ids = fields.Many2many('pi.users', 'admin_apps_pi_users_winners_rel', string='Winners', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points desc,unblocked_datetime desc,points_datetime asc,id asc")
    pi_users_winners_paid_ids = fields.Many2many('pi.users', 'admin_apps_pi_users_winners_paid_rel', string='Winners Paid', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points desc,unblocked_datetime desc,points_datetime asc,id asc")
    ...
    top_50_streamers_ids = fields.Many2many('pi.users', 'admin_apps_top_50_streamers_rel', string='Top 50 streamers', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points desc,unblocked_datetime desc,points_datetime asc,id asc")
    pi_users_leaders_zone_ids = fields.Many2many('pi.users', 'admin_apps_pi_users_leaders_zone_rel', string='Leaders Zone', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points desc,unblocked_datetime desc,points_datetime asc,id asc")
    pi_users_top10_zone_ids = fields.Many2many('pi.users', 'admin_apps_pi_users_top10_zone_rel', string='Top10 Zone', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points desc,unblocked_datetime desc,points_datetime asc,id asc")
    pi_users_top10_zone_chess_ids = fields.Many2many('pi.users', 'admin_apps_pi_users_top10_zone_chess_rel', string='Top10 Zone Chess', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points_chess desc,unblocked_datetime desc,points_datetime asc,points desc,id asc")
    pi_users_top10_zone_sudoku_ids = fields.Many2many('pi.users', 'admin_apps_pi_users_top10_zone_sudoku_rel', string='Top10 Zone Sudoku', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points_sudoku desc,unblocked_datetime desc,points_datetime asc,points desc,id asc")
    pi_users_top10_zone_snake_ids = fields.Many2many('pi.users', 'admin_apps_pi_users_top10_zone_snake_rel', string='Top10 Zone Snake', groups="website_pinetwork_odoo.group_pi_admin,base.group_system", default_order="points_snake desc,unblocked_datetime desc,points_datetime asc,points desc,id asc")
