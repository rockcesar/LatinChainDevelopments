...
class admin_apps_example(models.Model):
    _name = "admin.apps.example"
    _description = "Admin Pi Example App"
    
    _sql_constraints = [
        # Partial constraint, complemented by a python constraint (see below).
        ('admin_apps_example_unique_key', 'unique (app)', 'You can not have two app with the same App code!'),
    ]
