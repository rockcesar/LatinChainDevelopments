...
class admin_apps(models.Model):
    ...
    sandbox = fields.Boolean('Sandbox', required=True, groups="website_pinetwork_odoo.group_pi_admin,base.group_system")
    mainnet = fields.Boolean('Mainnet', required=True, default=False, groups="website_pinetwork_odoo.group_pi_admin,base.group_system")
    ...
    block_points = fields.Boolean('Block points', default=False, groups="website_pinetwork_odoo.group_pi_admin,base.group_system")
    amount = fields.Float('Amount', digits=(50,8), default=1, groups="website_pinetwork_odoo.group_pi_admin,base.group_system")
