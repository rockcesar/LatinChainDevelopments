...
class PiNetworkBaseController(http.Controller):
    ...
    @http.route('/api-docs/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    def api_external_docs(self, **kw):
        return http.request.redirect('https://github.com/pi-apps/LatinChain/tree/main/docs')
    
    @http.route('/mainnet/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    def latinchain_mainnet(self, **kw):
        return http.request.redirect('https://latinchain7588.pinet.com')
    
    @http.route('/testnet/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    def latinchain_testnet(self, **kw):
        return http.request.redirect('https://latinchaintest9869.pinet.com')
        
    @http.route('/odoo-tech-course/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    ...
    @http.route('/piapps-course/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    ...
    @http.route('/english-course/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    ...
    @http.route('/odoo-tech-book/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    def odoo_technical_book(self, **kw):
        return http.request.redirect('https://www.amazon.com/dp/B0DJVY51LS')
    
    @http.route('/piapps-book/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    def piapps_book(self, **kw):
        return http.request.redirect('https://www.amazon.com/dp/B0DK3NJ23V')
        
    @http.route('/terms/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    def latinchain_terms(self, **kw):
        return http.request.redirect('/blog/latinchain-blog-1/terms-of-service-6')
        
    @http.route('/privacy/', type='http', auth="none", methods=['GET'], csrf=False, save_session=False)
    def latinchain_privacy(self, **kw):
        return http.request.redirect('/blog/latinchain-blog-1/privacy-policy-5')
    
    @http.route('/api/get-external-winners', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/api/get-external-user', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/get-user', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/set-pi-ad-datetime', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/set-pi-wallet', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/set-streaming-url', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/set-referrer-code', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/set-latin-points', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/pi-ad-automatic', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/validate-memo', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/pi-api', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    def pi_api(self, **kw):
    ...
    @http.route('/pi-points', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/get-general-ranking/<string:pi_user_code>', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-general-ranking/', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-points/<string:pi_user_code>', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-points/', type='http', auth="none", csrf=False, save_session=False)
    ...
    """
    @http.route('/get-top10-zone/<string:pi_user_code>', type='http', auth="none")
    ...
    @http.route('/get-top10-zone/', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-top10-zone/<string:pi_user_code>', type='http', auth="none", csrf=False, save_session=False)
    def get_top10_zone_user(self, pi_user_code, **kw):
        domains_def = self.leaders_domain_def()
        leaders_domain = domains_def['leaders_domain']
        winner_domain = domains_def['winner_domain']
    ...
    @http.route('/get-winners-zone/', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-winners-zone/<string:pi_user_code>', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-streamers-zone/', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-streamers-zone/<string:pi_user_code>', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-credits/', type='http', auth="none", csrf=False, save_session=False)
    def get_credits(self, **kw):
        return http.request.render('website_pinetwork_odoo.list_credits')

    @http.route('/get-credits-data/', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/latinchain-academy/', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/latinchain-sports/', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/get-transactions-data/<string:source>', type='http', auth="none", methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/validation-key.txt', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/piapp-link-verification.txt', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/ads.txt', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/c31e6c84fe776276bd8ee62aa064f70c.txt', type='http', auth="none", csrf=False, save_session=False)
