...
class PiNetworkBaseController(http.Controller):
    ...
    @http.route('/latinchain-academy/', type='http', auth="public", website=True)
    ...
    @http.route('/latinchain-sports/', type='http', auth="public", website=True)
    ...
    def get_transactions(self, **kw):
        ...
        return http.request.render('website_pinetwork_odoo.list_transactions', {'no_footer': False, 'sandbox': sandbox, 'mainnet': mainnet, 'google_adsense': google_adsense})
