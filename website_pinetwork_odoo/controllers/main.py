...
class PiNetworkBaseController(http.Controller):
    ...
    @http.route('/get-external-user', type='http', auth="none", website=True, csrf=False, methods=['POST'])
    ...
    @http.route('/get-user', type='http', auth="none", website=True, csrf=True, methods=['POST'])
    ...
    @http.route('/pi-api', type='http', auth="none", website=True, csrf=True, methods=['POST'])
    def pi_api(self, **kw):
        return request.env["admin.apps"].pi_api(kw)
        
    @http.route('/pi-points', type='http', auth="none", website=True, csrf=True, methods=['POST'])
