...
class PiNetworkBaseController(http.Controller):
    ...
    @http.route('/get-external-user', type='http', auth="none", website=True, csrf=False, methods=['POST'], cors="*")
    ...
    @http.route('/get-user', type='http', auth="none", website=True, csrf=True, methods=['POST'], cors="*")
    ...
    @http.route('/pi-api', type='http', auth="none", website=True, csrf=True, methods=['POST'], cors="*")
    def pi_api(self, **kw):
        return request.env["admin.apps"].pi_api(kw)
        
    @http.route('/pi-points', type='http', auth="none", website=True, csrf=True, methods=['POST'], cors="*")
