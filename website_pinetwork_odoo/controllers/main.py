...
class PiNetworkBaseController(http.Controller):
    ...
    @http.route('/get-credits-data/', type='http', auth="public", website=True, methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/get-transactions-data/<string:source>', type='http', auth="public", website=True, methods=['POST'], csrf=False, save_session=False)
    ...
    @http.route('/validation-key.txt', type='http', auth="public", website=True, csrf=False, save_session=False)
    ...
    @http.route('/piapp-link-verification.txt', type='http', auth="public", website=True, csrf=False, save_session=False)
    ...
    @http.route('/ads.txt', type='http', auth="public", website=True, csrf=False, save_session=False)
    ...
    @http.route('/c31e6c84fe776276bd8ee62aa064f70c.txt', type='http', auth="public", website=True, csrf=False, save_session=False)
