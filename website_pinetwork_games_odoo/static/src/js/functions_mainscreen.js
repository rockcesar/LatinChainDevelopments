...
async function colorboxLoaded()
{
    ...
    {
        openInNewTab("https://ecosystem.latin-chain.com/page-1/?v=1.118"+hashLatinChainGoogleTranslate);
...
async function colorboxLoadedMainnet()
{
    ...
    {
        openInNewTab("https://ecosystem.latin-chain.com/page-mainnet/?v=1.118"+hashLatinChainGoogleTranslate);
