    ...
    if(pi_user_id != "" && pi_user_code != "")
    {
        ...
        return $.post( "/get-user", data).done(function(data) {
            ...
            if(data.result)
            {
                ...
                $("#avatar_user_img_div").html('<img src="/website_pinetwork_games_odoo/static/src/img/avatars_users/' + $("#avatar_user :selected").val() + '.jpeg?v=1.103" alt="LatinChain" class="img-fluid" style="max-width: 350px; border-radius: 25px;" width="100%" height="170px" />');
                $("#avatar_user").show();
        ...
        if(pi_user_id != "" && pi_user_code != "" && unblocked)
        {
            ...
            $.post( "/avatar-user", data).done(function(data) {
                ...
                if(data.result)
                {
                    ...
                    $("#avatar_user_img_div").html('<img src="/website_pinetwork_games_odoo/static/src/img/avatars_users/' + avatar_user + '.jpeg?v=1.103" alt="LatinChain" class="img-fluid" style="max-width: 350px; border-radius: 25px;" width="100%" height="170px" />');
                    $("#avatar_user_img_div").show();
                }
