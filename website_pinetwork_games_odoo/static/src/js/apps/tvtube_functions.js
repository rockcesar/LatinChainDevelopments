...
const channelsData = [
    ...
    { id: '', videoId: 'uGK8rHot0Pc', name: 'Telesur Spanish', country: 'International', category: 'News', color: 'from-red-600 to-red-800' },
    { id: '', videoId: '3nN3vtMzxTo', name: 'Telesur English', country: 'International', category: 'News', color: 'from-red-600 to-red-800' },
