...
class PiNetworkController(http.Controller):
    ...
    @http.route('/mahjong/', type='http', auth="public", website=True, save_session=False)
    def mahjong(self, **kw):
    ...
    @http.route('/modal-vote', type='http', auth="public", website=True, csrf=False, save_session=False)
    def modal_vote(self, **kw):
        
        return http.request.render('website_pinetwork_games_odoo.modal')
        
    @http.route('/modal-rules', type='http', auth="public", website=True, csrf=False, save_session=False)
    ...
    @http.route('/reading-club', type='http', auth="public", website=True, csrf=False, save_session=False)
    ...
    @http.route('/askanexpert', type='http', auth="public", website=True, csrf=False, save_session=False)
    ...
    @http.route('/latinchain-certification/<string:pi_user_code>', type='http', auth="public", website=True, csrf=False, save_session=False)
    ...
    @http.route('/latinchain-partners', type='http', auth="public", website=True, csrf=False, save_session=False)
