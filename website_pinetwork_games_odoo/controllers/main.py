...
class Website(Website):
    ...
    def index(self, **kw):
        ...
        if len(admin_app_list) == 0:
            ...
            pi_ad_hours = admin_app_list[0].pi_ad_seconds/3600
...
class PiNetworkController(http.Controller):
    ...
    @http.route('/tetris/', type='http', auth="none", csrf=False, save_session=False)
    def tetris(self, **kw):
    ...
    @http.route('/mahjong/', type='http', auth="none", save_session=False)
    def mahjong(self, **kw):
    ...
    @http.route('/latinchain-mainnet-redirect', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/latinchain_x', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/pinetwork', type='http', auth="none", csrf=False, save_session=False)
    def index(self, **kw):
        admin_app_list = request.env["admin.apps"].sudo().search([('app', '=', 'auth_example')])
    ...
    @http.route('/sudoku', type='http', auth="none", csrf=False, save_session=False)
    def sudoku(self, **kw):
    ...
    @http.route('/snake', type='http', auth="none", csrf=False, save_session=False)
    def snake(self, **kw):
    ...
    @http.route('/chess', type='http', auth="none", csrf=False, save_session=False)
    def chess(self, **kw):
        admin_app_list = request.env["admin.apps"].sudo().search([('app', '=', 'auth_platform')])
    ...
    @http.route('/modal-vote', type='http', auth="none", csrf=False, save_session=False)
    def modal_vote(self, **kw):
        
        return http.request.render('website_pinetwork_games_odoo.modal')
        
    @http.route('/modal-rules', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/reading-club', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/askanexpert', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/latinchain-certification/<string:pi_user_code>', type='http', auth="none", csrf=False, save_session=False)
    ...
    @http.route('/latinchain-partners', type='http', auth="none", csrf=False, save_session=False)
